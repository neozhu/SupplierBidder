...
/// Purpose:采购中心/联系人信息
/// Created Date: 3/23/2020 7:56:52 PM
/// Author: neo.zhu
...
/// </summary>
	...
	public class ContactsController : Controller
	{
		 ...
		 public async Task<JsonResult> GetData(int page = 1, int rows = 10, string sort = "Id", string order = "asc", string filterRules = "")
		{
			...
			var pagerows  = (await this.contactService
						               .Query(new ContactQuery().Withfilter(filters))
    ...
    Other = n.Other
		...
		[HttpPost]
		public async Task<JsonResult> SaveData(Contact[] contacts)
		{
            if (contacts == null)
            {
        ...
        //GET: Contacts/GetItem/:id
        [HttpGet]
        public async Task<JsonResult> GetItem(int id) {
            var  contact = await this.contactService.FindAsync(id);
		...
		public async Task<ActionResult> Create(Contact contact)
		{
            ...
            if (ModelState.IsValid)
			{
			    ...
			    //DisplaySuccessMessage("Has update a contact record");
			}
			else {
		...
		public async Task<ActionResult> Edit(Contact contact)
		{
			...
			if (ModelState.IsValid)
			{
				contact.TrackingState = TrackingState.Modified;
				                try{
		...
		{
          try{
               await this.contactService.Queryable().Where(x => x.Id == id).DeleteAsync();
		...
		public async Task<ActionResult> ExportExcel( string filterRules = "",string sort = "Id", string order = "asc")
		{
			...
			var stream = await this.contactService.ExportExcelAsync(filterRules,sort, order );
