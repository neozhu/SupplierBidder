...
namespace EntityFramework.OracleHelpers.Conventions
{
    ...
    {
        private readonly bool convertToUnderscore = true;
    ...
    public UpperCaseTableNameConvention(bool convertToUnderscore) => this.convertToUnderscore = convertToUnderscore;
    ...
    public UpperCaseForeignKeyNameConvention(bool convertToUnderscore) => this.convertToUnderscore = convertToUnderscore;
