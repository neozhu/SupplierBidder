...
/// Created Date: 2020/9/3 10:07:20
/// Author: neo.zhu
...
/// </summary>
    public interface IInventoryService:IService<Inventory>
    {
	    ...
	    Task Delete(int[] id);
    Task Outbound(outboundviewmodel[] data, string v);
     Task<(IEnumerable<PurchaseOrder>,IEnumerable<Outbound>, IEnumerable<Allocate>)> GetHistories(int id);
    Task Allocated(AllocateDto[] request, string v);
