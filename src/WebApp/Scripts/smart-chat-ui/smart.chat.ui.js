            ...
            _create: function () {
                ...
                var self = this,
                    ...
                    uiChatboxTitlebarClose = (self.uiChatboxTitlebarClose =
                      $('<a href="#" rel="tooltip" data-placement="top" data-original-title="Hide" title="Hide"></a>'))
                    ...
                    uiChatboxTitlebarMinimize = (self.uiChatboxTitlebarMinimize = $(
                            '<a href="#" rel="tooltip" data-placement="top" data-original-title="Minimize" title="Minimize"></a>'))
                        .addClass(//'ui-corner-all ' +
                            "ui-chatbox-icon"
                        )
                        .attr("role", "button")
